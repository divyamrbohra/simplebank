...
func (maker *PestoMaker) CreateToken(username string, duration time.Duration) (string, error) {
...
func (maker *PestoMaker) VerifyToken(token string) (*Payload, error) {
	payload := &Payload{}
